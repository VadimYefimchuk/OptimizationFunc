...
namespace Lab2
{
    public class Matrix
    {
        ...
        public void ArrayMulti6()
        {
            ...
            for (int i = 0; i < row; i++)
            {
                for (int j = 0; j < column; j++)
                {
                    ...
                    array[i, j] = array[i, j] * 6;
                }
            }
        }

        public void ArrayMulti10()
        {
            //int N = int.Parse(Console.ReadLine());
            for (int i = 0; i < row; i++)
            {
        ...
        public void FinalNormalization()
        {
            for (int i = 0; i < row; i++)
            {
                for (int j = 0; j < column; j++)
                {
                    array[i, j] = array[i, j]/10000000000000;
                }
            }
        }
